...
Game::Game()
{
	...
	rect2 = make_shared<Rectangle>();
	rect2->position = glm::vec2(250,450);
	rect2->scale = glm::vec2(100,100);
}
...
void Game::Draw()
{
	...
	if(rect1->isCollided_SAT(rect2.get()))
	{
