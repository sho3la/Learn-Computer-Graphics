	...
	m_height(height)
{
	...
	window_ptr = glfwCreateWindow(width, height, "Tutorial_07",NULL,NULL);
   ...
   spaceship = new Sprite("D:\\OpenglTutorial\\Learn-Computer-Graphics\\resources\\spaceship.png",glm::vec2(100,100));
}
